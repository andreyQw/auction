    ...
    context "Seller" do
      ...
      context "order_pending" do
        ...
        context "update status: (:pending -> :sent)" do
          it "should update" do
            put :status_update, params: { id: lot_closed.id, status: :sent }
        ...
        context "update status: (:pending -> :delivered)" do
          it "should not update" do
            put :status_update, params: { id: lot_closed.id, status: :delivered }
      ...
      context "order_delivered" do
        ...
        context "update status: (:delivered -> :pending)" do
          it "should not update" do
            put :status_update, params: { id: lot_closed.id, status: :pending }
            expect(response.status).to eq(401)
          end
        end
